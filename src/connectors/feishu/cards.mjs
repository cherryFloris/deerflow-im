...
// Ported verbatim from dsh-im src/channels/feishu/feishu-channel.mjs
// (the VerifiedFeishuChannel cardkit streaming engine). dsh-im's shared
// semantic/i18n helpers are stubbed locally; they are only used by the
// file/image delivery path (#sendArtifact), which im-bridge v1 does not invoke.
function t(message) {
  return message;
}

function trackOutboundArtifactProviderPromise() {
  return undefined;
}

function createDeliveryReceipt(value) {
  return value || {};
}
