// Ported verbatim from dsh-im src/channels/feishu/message-utils.mjs.
// dsh-im's shared i18n/image-prompt helpers are stubbed locally so this module
// is self-contained inside im-bridge (no dsh-im dependency).
function t(message) {
  return message;
}

class ImagePromptError extends Error {
